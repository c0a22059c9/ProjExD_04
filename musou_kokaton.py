...
class Shield(pg.sprite.Sprite):
    ...
    def __init__(self, bird: Bird, life: int):
        ...
        self.rect.centerx = bird.rect.right + 10
        self.life = life
...
def main():
    ...
    while True:
        ...
        # CapsLockキーが押され、かつスコアが50より大、かつ防御壁が他に存在しない場合
        if key_lst[pg.K_CAPSLOCK] and score.score >= 50 and shield is None:
            # 防御壁を生成し、Shieldグループに追加
        ...
        bomb_collision = pg.sprite.Group()

        # 衝突した爆弾を検出し、破壊する
        collided_bombs = pg.sprite.groupcollide(bombs, shields, True, False).keys()
        for bomb_collision in collided_bombs:
            exps.add(Explosion(bomb_collision, 50)) # 爆発エフェクト
            score.score_up(1) # 1点アップ
